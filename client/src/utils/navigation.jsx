...
// כתובות שמותרות למנהל עבודה — קטגוריית "כוח אדם" (בצפייה בלבד) +
// מלאי (בצפייה+עדכון, ר' חריג שני למטה). לא תפעול/מבנים/גידולים וכו'.
// חריג ראשון (2026-09-06): אישור/דחייה של בקשות עובדים — נבדק בנפרד
// בתוך WorkerRequestsPage.jsx, לא דרך canWrite הכללי כאן.
// חריג שני (2026-09-07): עדכון מלאי — נבדק בנפרד בתוך InventoryPage.jsx.
export const OPERATIONS = ['/crew', '/workers', '/requests', '/inventory'];

/** הרשאת עדכון/מחיקה — למנהל הראשי בלבד. מנהל עבודה צופה בלבד, פרט
 *  לשני החריגים הנקודתיים (ר' הערה למעלה): אישור/דחייה של בקשות עובדים
 *  ועדכון מלאי. */
